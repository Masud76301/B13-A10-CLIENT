...
export default function SignUpPage() {
    const [form, setForm] = useState({ name: "", email: "", image: "", password: "", role: "user", plan: "free" }); 
    ...
    const handleSubmit = async () => {
        ...
        // Run Password Rule Validation Check
        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
            <Card className="w-full max-w-md p-2 shadow-xl">
                ...
                <Card.Content className="flex flex-col gap-5 px-6 py-4">
                    ...
                    {message.text && (
                        <div
                            className={`text-sm p-3 rounded-lg font-medium w-full block transition-opacity duration-300 ${
                ...
                <Card.Footer className="flex flex-col gap-4 pb-6 items-center">
                    ...
                    <p className="text-center text-sm text-gray-600">
                        ...
                        <Link href={`/auth/signin?redirect=${redirectTo}`} className="text-blue-600 hover:underline font-medium">
                            Go to sign in
                        </Link>
                    </p>
                </Card.Footer>
